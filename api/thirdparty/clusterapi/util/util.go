...
import (
	...
	clusterv1 "github.com/openshift/hypershift/api/thirdparty/clusterapi/api/v1alpha4"
	"github.com/openshift/hypershift/api/thirdparty/clusterapi/util/annotations"
)
