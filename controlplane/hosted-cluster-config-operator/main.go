...
import (
	...
	"github.com/openshift/hypershift/controlplane/hosted-cluster-config-operator/controllers/autoapprover"
	"github.com/openshift/hypershift/controlplane/hosted-cluster-config-operator/controllers/clusteroperator"
	"github.com/openshift/hypershift/controlplane/hosted-cluster-config-operator/controllers/clusterversion"
	"github.com/openshift/hypershift/controlplane/hosted-cluster-config-operator/controllers/cmca"
	"github.com/openshift/hypershift/controlplane/hosted-cluster-config-operator/controllers/infrastatus"
	"github.com/openshift/hypershift/controlplane/hosted-cluster-config-operator/controllers/kubeadminpwd"
	"github.com/openshift/hypershift/controlplane/hosted-cluster-config-operator/controllers/kubeletservingca"
	"github.com/openshift/hypershift/controlplane/hosted-cluster-config-operator/controllers/node"
	"github.com/openshift/hypershift/controlplane/hosted-cluster-config-operator/controllers/openshiftapiservermonitor"
	"github.com/openshift/hypershift/controlplane/hosted-cluster-config-operator/operator"
)
