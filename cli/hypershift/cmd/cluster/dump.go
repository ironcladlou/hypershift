...
import (
	...
	"github.com/openshift/hypershift/cli/hypershift/cmd/util"
	capiv1 "github.com/openshift/hypershift/cli/hypershift/thirdparty/clusterapi/api/v1alpha4"
	capiaws "github.com/openshift/hypershift/cli/hypershift/thirdparty/clusterapiprovideraws/v1alpha4"
)
...
func DumpCluster(ctx context.Context, opts *DumpOptions) error {
	...
	controlPlaneNamespace := HostedControlPlaneNamespace(opts.Namespace, opts.Name).Name
